<?php
	...
	$materia = CatalogoMaterias::select('nombre_completo_materia','clave','t_cat_organigrama.descripcion')->join('t_cat_organigrama','t_cat_materias.fk_cat_organigrama','t_cat_organigrama.id_cat_organigrama')->where('id_cat_materias',$_POST['materia'])->first();
	...
	$pdf->Output('D', 'acta_calificaciones_examen_especial.pdf');
?>

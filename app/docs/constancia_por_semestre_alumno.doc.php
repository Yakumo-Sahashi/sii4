<?php
    ...
    $pdf->SetFont('Arial','',9);
    $pdf->Cell(40,5,utf8_decode('CONSTANCIA DE ESTUDIOS'),0,1,'L');
    $pdf->Ln(5);
   ...
   /*  $pdf->Cell(140,6,'',0,0,'C',true);
    ...
    $pdf->Ln(3);
    $pdf->Cell(192,6,utf8_decode('CNO - Curso Normal Ordinario CNR - Curso Normal Regularización CNE - Curso Normal Extraordinario'),0,1);
    $pdf->Cell(192,6,utf8_decode('CRO - Curso Repetición Ordinario CRR - Curso Reptición Regularización EE - Exámen Especial'),0,1);

    $pdf->Ln(3);
    $pdf->Cell(60,4,utf8_decode('Porcentaje de avance'),0,1,'L',true);
    $pdf->Cell(60,4,utf8_decode('Créditos acumulados 239 de un total 260 que integran el plan de estudios ISIC-2010-224'),0,1,'L',true);
    $pdf->Cell(60,4,utf8_encode('Promedio genera'),0,1,'L',true);
    ...
    $pdf->Output('D', 'constancia_estuidos_por_semestre.pdf');
?>
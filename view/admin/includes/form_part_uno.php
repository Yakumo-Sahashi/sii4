<div id="form_part_uno" class="">
    ...
    <div class="row align-items-end mb-3 justify-content-center">
        ...
        <div class="col-lg-4 col-md-6 text-start">
            <div class="form-floating mb-3">
                ...
                <label for="sexo" class="text-primary"><i class="fas fa-venus-mars fa-lg me-2"></i> Sexo</label>
            </div>
        </div>
    </div>
    <div class="row align-items-end mb-3 prueba justify-content-center">
        <div class="col-lg-4 col-md-6 text-start">
            <div class="form-floating mb-3">
                ...
                <label for="edo_civil" id="label_mt" class="text-primary"><i class="fas fa-ring me-2"></i> Estado Civil</label>
            </div>
        </div>
        <div class="col-lg-4 col-md-6 text-start">
            <div class="form-floating mb-3">
    ...
    <div class="row align-items-end prueba justify-content-center">
        ...
        <div class="col-lg-6 text-start">
            <div class="form-floating mb-3">
                <select class="form-select" name="escolaridad" id="escolaridad"></select>
                <label for="escolaridad" class="text-primary"><i class="fa-solid fa-graduation-cap me-2"></i>Escolaridad</label>
            </div>
        </div>
    </div>
</div>

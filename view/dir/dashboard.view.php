    ...
    <div class="row">
        <div class="col-md-12">
            <div class="row row-cols-2 row-cols-sm-3 row-cols-md-4 row-cols-lg-5 g-4">
                <div class="col">
                    <a href="<?=Router::redirigir('dashboard_admin')?>" class="btn w-100 p-0">
                        <div class="card shadow p-3 itma2-card itma2-card-hover sin-scroll">
                            <div class="card-body text-center">
                                <i class="fa-solid fa-chalkboard fa-4x mx-auto d-block"></i>
                                <span class="d-block mt-3">Administrador</span>
                            </div>
                        </div>
                    </a>
                </div>
                ...
                <div class="col">
                    <a href="<?=Router::redirigir('dashboard_rh')?>" class="btn w-100 p-0">
                        <div class="card shadow p-3 itma2-card itma2-card-hover sin-scroll">
                            <div class="card-body text-center">
                                <i class="fa-solid fa-person-chalkboard fa-4x mx-auto d-block"></i>
                                <span class="d-block mt-3">Recursos Humano</span>
                            </div>
                        </div>
                    </a>
                </div>
                <div class="col">
                    <a href="<?=Router::redirigir('dashboard_departamento')?>" class="btn w-100 p-0">
                        <div class="card shadow p-3 itma2-card itma2-card-hover sin-scroll">
                            <div class="card-body text-center">
                                <i class="fa-solid fa-person-shelter fa-4x mx-auto d-block"></i>
                                <span class="d-block mt-3">Jefe De Carrera</span>
                            </div>
                        </div>
                    </a>
                </div>
